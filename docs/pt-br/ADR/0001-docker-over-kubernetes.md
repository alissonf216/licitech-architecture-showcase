...
> **Idioma:** [English](../../ADR/0001-docker-over-kubernetes.md) · Português (Brasil)
...
A Licitech precisava de um modelo de deploy em produção para poucos serviços de longa duração (API, workers), além de serviços de dados gerenciados. O tamanho do time e o perfil de tráfego ainda não justificavam um control plane completo de Kubernetes. Ao mesmo tempo, precisávamos de builds reproduzíveis, restart baseado em health check e escala horizontal sem drama.
