...
> **Idioma:** [English](../OBSERVABILITY.md) · Português (Brasil)
...
A Licitech segue os três pilares clássicos, com correlation IDs costurando tudo:
...
Plano de adoção: auto-instrumentar HTTP + clients de DB primeiro; spans customizados em seções críticas de domínio depois. Veja [ROADMAP.md](../../ROADMAP-pt-br.md).
