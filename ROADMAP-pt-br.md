...
> **Idioma:** [English](ROADMAP.md) · Português (Brasil)

Este roadmap descreve como a plataforma Licitech deve evoluir em arquitetura e operação. É propositalmente alto nível e independente de qualquer implementação proprietária.
...
| Segurança em camadas | ✅ Em produção | Ver [SECURITY_AND_COMPLIANCE.md](docs/pt-br/SECURITY_AND_COMPLIANCE.md) |
...
O [ADR 0001](docs/pt-br/ADR/0001-docker-over-kubernetes.md) registra a decisão original e os critérios de saída.
...
- Metas alongadas: RPO ≤ 1 h / RTO ≤ 4 h (ver [DISASTER_RECOVERY.md](docs/pt-br/DISASTER_RECOVERY.md))
...
- [ARCHITECTURE.md](docs/pt-br/ARCHITECTURE.md)
- [DEVOPS_AND_CICD.md](docs/pt-br/DEVOPS_AND_CICD.md)
- [SCALABILITY.md](docs/pt-br/SCALABILITY.md)
- [DISASTER_RECOVERY.md](docs/pt-br/DISASTER_RECOVERY.md)
- [Índice de ADRs](docs/pt-br/ADR/)
